...
- ブランチ: `main`
- HEAD / upstream: `main` は `origin/main` と一致。サイト本体は `1caecd9`。
...
- 本番のスマホ幅・PC幅の目視を完了。ヘッダー、固定バー、採用カード、フォームに特段の問題は見られなかった（ユーザー確認、2026-09-10）。
...
- 本番のスマホ幅・PC幅の目視（ヘッダー、固定バー、採用カード、フォーム）— 問題なし。2026-09-10。ユーザー確認。
- 未実施: 実機iPhone、キーボードだけの操作、文字200%、フォーム実送信。
